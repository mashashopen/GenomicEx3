...
for sample in $samples; do
    ...
    /home/mashashopen/fastp --in1 data/$sample\_1.fastq --in2 data/$sample\_2.fastq --out1 fastqc_better_results/$sample\_1.fastp.fastq --out2 fastqc_better_results/$sample\_3.fastp.fastq --unpaired1 fastqc_better_results/$sample\_1.unpaired.fastq --unpaired2 fastqc_better_results/$sample\_2.unpaired.fastq --average_qual 30 --trim_front1 15 --trim_tail1 1 --length_required 60 -O fastqc_better_results
